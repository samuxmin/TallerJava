...
import org.tallerjava.moduloGestionCliente.dominio.eventos.CargaSaldo;
import org.tallerjava.moduloGestionCliente.dominio.eventos.DesvincularVehiculo;
...
public class GestionClienteTest {
    ...
    public void saldoTest() {
        ...
        gestionClienteService.realizarPrePago(carga1,usuario);
